...
public class Motion {
	public static void main(String[] args) {
		...
		// Read a video. BoofCV can only read MJPEG video.
		// convert it by using ffmpeg "ffmpeg -i FILINAME -qscale 0 NEWFILENAME"
		String fileName = UtilIO.pathExample("chipmunk.mjpeg");
...
//				configDetector,configDescribe,configOrientation,GrayF32.class);
		...
		ConfigBackgroundGaussian configGaussian = new ConfigBackgroundGaussian(12,0.1f);
